...
//  */
// class SerialCommunicationChannel : public Task
// {
...
//      */
//     SerialCommunicationChannel(JsonProcessor jsonProcessor, int period, WaterChannelController *waterChannelController);
